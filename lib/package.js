...
/**
 * Holds information of the yarn package
 *
 * @class Package
 */
...
Package.prototype = {
    ...
    collectData: function() {
        //The package might not contain package.json which defines the main property
        //to resolve this we will check if there is a bower related files which might contain the main property definition
        var paths = [
        ...
        if (this.dependencies === undefined && data.dependencies) {
    ...
    getFiles: function(force) {
        ...
        main.forEach(function(pattern) {
            if (pattern[0] === '/') {
                throw new Error('absolute path in yarn main is not supported');
            }
